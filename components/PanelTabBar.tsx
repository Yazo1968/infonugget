...
type PanelId = 'sources' | 'chat' | 'smart-deck' | 'docviz' | 'composer' | 'cards' | 'quality';
...
const TABS: TabConfig[] = [
  ...
  },
  {
    ...
    label: 'Composer',
    requiresNugget: true,
    color: { dark: 'rgb(105,160,228)', light: 'rgb(105,160,228)' },
    dimColor: { dark: 'rgb(55,86,125)', light: 'rgb(55,86,125)' },
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
