              ...
              <div className="space-y-5">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    id="style-technique"
                    value={editTechnique}
                    onChange={(e: ChangeEvent<HTMLTextAreaElement>) => { const v = e.target.value; if (v.length <= 150 || v.length < editTechnique.length) { setEditTechnique(v); autoResize(e.target); } }}
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    onChange={(e: ChangeEvent<HTMLTextAreaElement>) => { const v = e.target.value; if (v.length <= 100 || v.length < editComposition.length) { setEditComposition(v); autoResize(e.target); } }}
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    id="style-mood"
                    value={editMood}
                    onChange={(e: ChangeEvent<HTMLTextAreaElement>) => { const v = e.target.value; if (v.length <= 60 || v.length < editMood.length) { setEditMood(v); autoResize(e.target); } }}
